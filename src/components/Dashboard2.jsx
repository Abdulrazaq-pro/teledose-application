...
const Dashboard = () => {
  ...
  return (
    <div className="relative flex flex-col h-screen">
        ...
        <nav className="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
          <div className="me-5 lg:me-0 lg:hidden">
            <a
              ...
              aria-label="Preline"
            >
              <p className="text-green-600 font-bold italic">Telemed</p>
            </a>
          </div>
          ...
          <div className="hidden md:block">
            <div className="relative">
              ...
              <input
                type="text"
                className="py-2 ps-10 pe-16 block w-full bg-white border-gray-200 rounded-lg text-sm focus:outline-none focus:border-green-500 focus:ring-green-500 disabled:opacity-50 disabled:pointer-events-none"
                placeholder="Search"
              />
      ...
      {/* Main Content */}
      {/* Main Content */}
      <div className="flex-1 flex flex-col lg:pl-64 h-screen overflow-scroll mb-48">
